export default {
  ...
  about: {
    title: "Sobre Mí",
    subtitle: "Conoce más sobre mí y mi trayectoria profesional",
    whoAmI: "¿Quién soy?",
    email: "Correo",
    location: "Ubicación",
    education: "Educación",
  ...
  skills: {
    ...
    technologies: {
      ...
      eventDriven: "Arquitectura Orientada a Eventos",
    },
  },
  projects: {
  ...
  personal: {
    ...
    education: "Técnico en Diseño y Desarrollo de Aplicaciones",
    experience: "7+ años en desarrollo .NET",
    interests: [
  ...
  work: {
    seniorAnalyst: {
      title: "Analista Senior de Desarrollo de Aplicaciones",
      company: "Dirección General de Aduanas",
      period: "Septiembre 2019 - Presente",
      location: "Santo Domingo, República Dominicana",
      description: {
        0: "Lideré el desarrollo de un portal de aplicaciones internas, aumentando la productividad del equipo en un 35% y optimizando la gestión de herramientas clave",
        1: "Mejoré el rendimiento de la base de datos, reduciendo los tiempos de respuesta de 15s a 1s mediante optimización de consultas SQL",
    ...
    webDeveloper: {
      ...
      period: "Marzo 2017 - Junio 2018",
      location: "Santo Domingo, República Dominicana",
      description: {
        0: "Mejoré el rendimiento de la plataforma PagaTodo, reduciendo los tiempos de carga en un 30% mediante mejoras en la estructura del sistema",
        1: "Desarrollé e integré mejoras en pasarelas de pago y autenticación, aumentando la seguridad y confiabilidad del sistema",
      },
    },
  },
  education: {
